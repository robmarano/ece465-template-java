...
docker run -d --rm=true --publish 2182:2181 --publish 9666:8080 --env-file zookeeper2.env --mount source=zookeeper2-dataDir,target=/data --mount source=zookeeper2-dataLogDir,target=/datalog --mount source=zookeeper2-logs,target=/logs --name zookeeper2 --network zookeeper-cluster zookeeper:3.8.3
